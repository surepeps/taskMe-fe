        ...
        <div className='flex flex-col w-full lg:w-[537px] rounded-xl gap-5 bg-[#ffffff] px-10 py-12 border border-[#d6d6d6]'>
          ...
          <div className="middle">
            <form action="">
              ...
              <div className="w-full mb-4">
                <button className="bg-[#0016df] border border-[#0016df] text-sm text-white w-full rounded-lg py-4 hover:bg-transparent hover:text-[#0016df] transition duration-300 ease-in-out "> Login</button>
              </div>
            </form>
          </div>
